...
<body>
    <div>
        ...
        <form class="form" action="handle/handleRegister.php" method="post">
            ...
            <input class="input" placeholder="Enter your phone " type="text" name="phone" value="<?php if (!empty($_SESSION["phone"])) echo $_SESSION["phone"];
                        unset($_SESSION["phone"]) ?>">
            <button type="submit" name="submit">Register</button>
            <span>If You Have An Acoount <a href="Login.php">Log in</a></span>
        </form>
    </div>
</body>
